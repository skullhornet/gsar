...
190822 : 1.50
         . Removed the gsar.1 file
         . Added -O2 to the makefile

         . Introduced the concept of text modifiers. A text modifier
           will transform the search and replace strings in various ways.
           
         . New option: -w
           Transform the search and replace strings into wide characters by
           appending each byte in the original string with a 0 byte. (Little-Endian)

           ./gsar -sgsar -w -B

           Search buffer  (ASCII) : g.s.a.r.
           Length =   8   (Hex)   : 67 00 73 00 61 00 72 00

         . New option: -X
           Interpret the search and replace strings as hexadecimal strings.
           Each character will be interpreted as a nybble in a byte.

           gsar -saAbB  -B

           Search buffer  (ASCII) : aAbB
           Length =   4   (Hex)   : 61 41 62 42
