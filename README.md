# gsar
          ...
          OPTIONS
             ...
             -w  
                 Transform the search and replace strings into wide 
                 characters by appending each byte in the original string 
                 with a 0 byte. (Little-Endian)
             ...
             -X 
                 Interpret the search and replace strings as hexadecimal 
                 strings. Each character will be interpreted as a nybble in
                 a byte.
